...
| **Flow** | — | only appears with a use-case or entry point active, and draws whichever of them you selected last: UC → numbered vertical chain of hops; entry point (or a call tree launched from Symbols) → top-down call tree |
