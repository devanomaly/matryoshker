...
export const DESIGN_NODE_TYPE_ALIASES = {
    frame: "screen",
    artboard: "screen",
    canvas: "page",
...
export const NON_DESIGN_NODE_TYPE_ALIASES = {
    page: "article",
};
...
export const DESIGN_EDGE_TYPE_ALIASES = {
...
export const NON_DESIGN_EDGE_TYPE_ALIASES = {
