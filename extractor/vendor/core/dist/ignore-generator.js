 ...
 */
function parseGitignorePatterns(gitignorePath) {
 ...
 */
function isCoveredByDefaults(pattern) {
...
export function generateStarterIgnoreFile(projectRoot) {
    ...
    const gitignorePatterns = parseGitignorePatterns(gitignorePath).filter((p) => !isCoveredByDefaults(p));
...
//# sourceMappingURL=ignore-generator.js.map