...
beforeAll(async () => {
    ...
    await Parser.init();
    const wasmPath = require.resolve("@understand-anything/tree-sitter-dart-wasm/tree-sitter-dart.wasm");
...
`);
            ...
            expect(result.classes[0].properties).toEqual(expect.arrayContaining(["count", "label"]));
...
//# sourceMappingURL=dart-extractor.test.js.map