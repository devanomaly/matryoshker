...
`;
            ...
            const greetCall = result.find((e) => e.caller === "main" && e.callee === "greet");
            expect(greetCall).toBeDefined();
            const formatCall = result.find((e) => e.caller === "greet" && e.callee === "formatMessage");
...
//# sourceMappingURL=tree-sitter-plugin.test.js.map