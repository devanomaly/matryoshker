 ...
 */
function cosineSimilarityWithQueryMag(query, queryMag, vec) {
    if (queryMag === 0)
        return 0;
    let dot = 0;
    let magB = 0;
...
export class SemanticSearchEngine {
    ...
    search(queryEmbedding, options) {
        ...
        for (const node of this.nodes) {
            ...
            if (!embedding)
                continue;
            const similarity = cosineSimilarityWithQueryMag(queryEmbedding, queryMag, embedding);
...
//# sourceMappingURL=embedding-search.js.map