...
const styles = { meta: { styles: [{ key: "S_KEY", name: "color/brand-500", style_type: "FILL" }] } };
const structural = [
...
describe("extractTokens — nested styled layers", () => {
    ...
    const nestedStyles = { meta: { styles: [{ key: "T_KEY", name: "type/heading", style_type: "TEXT" }] } };
    const nestedStructural = [
