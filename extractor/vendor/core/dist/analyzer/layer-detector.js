...
export function detectLayers(graph) {
    const layerMap = new Map(); // layerName -> nodeIds
        ...
        for (const item of parsed) {
            ...
            layers.push({
                ...
                filePatterns: Array.isArray(item.filePatterns)
                    ? item.filePatterns.filter((p) => typeof p === "string")
                    : [],
            });
        }
...
//# sourceMappingURL=layer-detector.js.map